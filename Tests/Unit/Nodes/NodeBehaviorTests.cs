...
{
    private NodeTestRunner _testRunner;

    [TestInitialize]
    public void TestInitialize()
    {
        // Create a test runner without terminal mocking (we don't need it for these tests)
        _testRunner = new NodeTestRunner(setupTerminalMock: false);
    }
    ...
    public void StoryNode_CanBeCreatedAndTested()
    {
        ...
        var storyNode = _testRunner.CreateNode<StoryNode>(nodeId: 1, node =>
        {
        ...
        _testRunner.TestNode<StoryNode>(node =>
        {
    ...
    public void DialogueNode_CanBeCreatedAndTested()
    {
        ...
        var dialogueNode = _testRunner.CreateNode<DialogueNode>(nodeId: 1, node =>
        {
            node.Dialogues = [
                new Dialogue { Actor = "Hero", Line = "Hello world", Break = true },
                new Dialogue { Actor = "Villain", Line = "Goodbye world" }
            ];
        });
    ...
    public void ChoiceNode_CanBeCreatedAndTested()
    {
        ...
        _testRunner.TestNode<ChoiceNode>(node =>
        {
    ...
    public void ActionNode_CanBeCreatedAndTested()
    {
        ...
        _testRunner.TestNode<ActionNode>(node =>
        {
